    ...
    r(l, [], function() {
        ...
        var t = e.extend({
            ...
            Statics: {
                ...
                msgBox: function(n) {
                    ...
                    switch (n.buttons) {
                        case t.OK_CANCEL:
                            i = [r("Ok", !0, !0), r("Annuler", !1)];
                            break;
                        case t.YES_NO:
                        case t.YES_NO_CANCEL:
                            i = [r("Yes", 1, !0), r("No", 0)], n.buttons == t.YES_NO_CANCEL && i.push(r("Annuler", -1));
                            break;
                        default:
                            i = [r("Ok", !0, !0)]
                    }
        ...
        function y(c) {
            ...
            function Y() {
                ...
                c.on("mouseup", function() {
                    ...
                    var n;
                    if (n = t(e.target)) x(n) ? (e.preventDefault(), G(A(n))) : (J(), r(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY));
                    else {
                        J(), re.hide();
        ...
        function a(e) {
            ...
            u = i(), s({
                ...
                outdent: ["Suppr indent", "Outdent"],
                indent: ["Ajout indent", "Indent"],
                cut: ["Couper", "Cut"],
                copy: ["Copier", "Copy"],
                paste: ["Coller", "Paste"],
                help: ["Aide", "mceHelp"],
                selectall: ["Tout sélectionner", "SelectAll"],
                removeformat: ["Effacer le format", "RemoveFormat"],
                visualaid: ["Visual aids", "mceToggleVisualAid"],
                newdocument: ["Nouv Document", "mceNewDocument"]
            }, function(t, n) {
                e.addButton(n, {
                    tooltip: t[0],
                    cmd: t[1]
                ...
                blockquote: ["Commentaire", "mceBlockQuote"],
                numlist: ["Liste numérique", "InsertOrderedList"],
                bullist: ["Liste puce", "InsertUnorderedList"],
                subscript: ["Indice", "Subscript"],
                superscript: ["Exposant", "Superscript"],
                alignleft: ["A gauche", "JustifyLeft"],
                aligncenter: ["Centré", "JustifyCenter"],
                alignright: ["A droite", "JustifyRight"],
                alignjustify: ["Justifié", "JustifyFull"],
                alignnone: ["Sans alignement", "JustifyNone"]
            }, function(t, n) {
                e.addButton(n, {
                    tooltip: t[0],
                    cmd: t[1],
    ...
    function d(b) {
        ...
        i = v.getNode(), j = w.getParent(i, "a[href]"), m = h(), u.text = k = j ? j.innerText || j.textContent : v.getContent({
            ...
            onSubmit: function(b) {
                ...
                var e;
                return u = tinymce.extend(u, b.data), (e = u.href) ? e.indexOf("@") > 0 && -1 == e.indexOf("//") && -1 == e.indexOf("mailto:") ? void c("L'URL que vous avez saisi semble être une addresse mail. Voulez vous rajouter le préfixe mailto: ?", function(a) {
                    a && (e = "mailto:" + e), d()
                }) : a.settings.link_assume_external_targets && !/^\w+:/i.test(e) || !a.settings.link_assume_external_targets && /^\s*www[\.|\d\.]/i.test(e) ? void c("L'URL que vous avez saisi semble être un lien extrene. Voulez vous rajouter le préfixe http:// ?", function(a) {
                    a && (e = "http://" + e), d()
    ...
    d("tinymce/pasteplugin/Utils", ["tinymce/util/Tools", "tinymce/html/DomParser", "tinymce/html/Schema"], function(a, b, c) {
        ...
        return function(f) {
            ...
            function h(a) {
                ...
                var b, c = f.dom.getParent(f.selection.getStart(), f.dom.isBlock),
            ...
            function t() {
                ...
                f.on("keydown", function(b) {
                    ...
                    if (s(b) && !b.isDefaultPrevented()) {
                        ...
                        if (b.stopImmediatePropagation(), y = (new Date).getTime(), a.ie && w) return b.preventDefault(), void f.fire("paste", {
                            ieFake: !0
                        });
                ...
                f.on("paste", function(c) {
                    ...
                    return w = !1, c.isDefaultPrevented() || p(c) ? void j() : !n(g) && o(c, t()) ? void j() : (l || c.preventDefault(), !a.ie || l && !c.ieFake || (i(), f.dom.bind(u, "paste", function(a) {
                        a.stopPropagation()
                    ...
                    if (i = q(a), !a.isDefaultPrevented() && !z && (b = l(a.dataTransfer), (n(b) && !c(b) || !o(a, i)) && i && f.settings.paste_filter_drop !== !1)) {
                        ...
                        j && (a.preventDefault(), e.setEditorTimeout(f, function() {
                            f.undoManager.transact(function() {
                                b["mce-internal"] && f.execCommand("Delete"), f.selection.setRng(i), j = d.trimHtml(j), b["text/html"] ? g(j) : h(j)
                            })
                        }))
                    }
        ...
        a.add("paste", function(a) {
            ...
            function g() {
                if ("text" == h.pasteFormat) this.active(!1), h.pasteFormat = "html", a.fire("PastePlainTextToggle", {
                    state: !1
                });
                    ...
                    a.notificationManager.open({
                        text: b,
                        type: "info"
                    }), e = !0, a.fire("PastePlainTextToggle", {
                        state: !0
                    })
                }
                a.focus()
...
tinymce.PluginManager.add("textcolor", function(a) {
    ...
    function d() {
        ...
        for (m = n.settings.origin, d = c(m), d.push({
            ...
            for (f += "<tr>", h = 0; h < i[m]; h++) l = k * i[m] + h, l > g ? f += "<td></td>" : (e = d[l], f += b(e.color, e.text));
            f += "</tr>"
        }
        if (a.settings.color_picker_callback) {
            for (f += '<tr><td colspan="' + i[m] + '" class="mce-custom-color-btn"><div id="' + o + '-c" class="mce-widget mce-btn mce-btn-small mce-btn-flat" role="button" tabindex="-1" aria-labelledby="' + o + '-c" style="width: 100%"><button type="button" role="presentation" tabindex="-1">' + tinymce.translate("Custom...") + "</button></div></td></tr>", f += "<tr>", h = 0; h < i[m]; h++) f += b("", "Custom color");
            f += "</tr>"
        }
    ...
    function g(c) {
        ...
        var j, k, l = this.parent();
        k = l.settings.origin, tinymce.DOM.getParent(c.target, ".mce-custom-color-btn") && (l.hidePanel(), a.settings.color_picker_callback.call(a, function(a) {
            var b, c, e, f = l.panel.getEl().getElementsByTagName("table")[0];
            ...
            h(c, a), d(a)
        }, b(l.settings.format))), j = c.target.getAttribute("data-mce-color"), j ? (this.lastId && document.getElementById(this.lastId).setAttribute("aria-selected", !1), c.target.setAttribute("aria-selected", !0), this.lastId = c.target.id, "transparent" == j ? g() : d(j)) : null !== j && l.hidePanel()
    }
